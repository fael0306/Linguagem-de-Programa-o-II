...
public class P2nX {
	...
	public static void main(String[] args) {
		...
		objeto.add(new Homem("Carlos Eduardo", "Balbino", 21, 5, 1967, 83927107700L, 110, 1.68F));
		objeto.add(new Homem("Isaias Luiz", "dos Santos", 27, 10, 1974, 85457655415L, 70, 1.65F));
		objeto.add(new Homem("Isaias Luiz", "dos Santos Junior", 4, 4, 1996, 11764822463L, 80, 1.80F));
		objeto.add(new Mulher("Isabella","Oliveira dos Santos",28,9,1999,11764832426L,55,1.67F));
